...
milliseconds = tk.StringVar(value="00")
...
ms = tk.Entry(window, font=("Verdana", 40), bg="#dad7cd", justify='center', width=5, textvariable=milliseconds, state="disabled")
ms.place(x=615, y=150)
